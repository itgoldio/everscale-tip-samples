...
class Collection(ts4.BaseContract):
    ...
    def __init__(
        ...
        code_index: ts4.Cell = ts4.load_code_cell('Index.tvc'),
        code_index_basis: ts4.Cell = ts4.load_code_cell('IndexBasis.tvc'),
        ...
        if ctor_params is None:
            ctor_params = {
                ...
                'codeIndexBasis': code_index_basis,
    ...
    def mint_nft(
        ...
        call_set = CallSet('mintNft', input={})
        nft_owner.send_call_set(self, value=mint_value, call_set=call_set, expect_ec=expect_ec, dispatch=dispatch)

...
contract Collection is TIP4_3Collection, TIP4_4Collection, ITokenBurned {
    ...
    function mintNft(
        ...
        require(msg.value > _remainOnNft + _mintingFee + (2 * _indexDeployValue) + _storageDeployValue, CollectionErrors.value_is_less_than_required);
    ...
    function _buildNftState(
        TvmCell code,
        uint256 id
    ) internal virtual override(TIP4_3Collection, TIP4_4Collection) pure returns (TvmCell) {
